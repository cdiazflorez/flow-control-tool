...
import static com.mercadolibre.flow.control.tool.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.flow.control.tool.util.ScopeUtils.isLocalScope;
...
public class SpringDocConfig {
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("franco tagliero")
                .email("franco.tagliero@mercadolibre.com"));
